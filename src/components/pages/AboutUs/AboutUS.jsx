  ...
  return (
    <div className="bg-blue-50">
      ...
      >
        ...
        Our bags are packed. We’re available for editorial and commercial travel photo assignments worldwide.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="rounded-2xl overflow-hidden shadow-2xl">
            <img
              ...
              src="https://i.ibb.co/2jmtRkg/pexels-rachel-claire-4825701.jpg"
              alt=""
            />
          </div>
          <div className="p-10">
